...
public class CookieCacheHelper {
     ...
     * @return
     */
    public Object retrieveObjectFromCache(String cacheKey) {
     ...
     * @param object
     */
    public void storeObjectInCache(String cacheKey, Object object) {
     ...
     */
    public void storeObjectInCache(String cacheKey, Object object, int timeToLiveInMilliseconds) {
