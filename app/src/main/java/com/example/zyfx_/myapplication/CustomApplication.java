...
import com.greendao.greendao.DaoMaster;
import com.greendao.greendao.DaoSession;
import com.lzy.okgo.*;
...
//              .setCookieStore(new MemoryCookieStore())            //cookie使用内存缓存（app退出后，cookie消失）
    ...
    public void initGreenDao(String dbName) {
        DaoMaster.DevOpenHelper devOpenHelper = new DaoMaster.DevOpenHelper(this, dbName, null);
